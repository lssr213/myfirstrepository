...
public class BookingsPage {
	...
	@FindBy(css = "xyz")
	private WebElement paymentOptionPaypalElement;
	...
	public void selectPaymentOption(String paymentOption) {
		Select selectPaymentOption = new Select(paymentOptionPaypalElement);
		selectPaymentOption.selectByVisibleText(paymentOption);
	}
}